...
// Icon Components
const VehicleIcon1 = () => (
  <svg className="w-8 md:w-[51px] h-auto" fill="none" viewBox="0 0 51 28">
    <path d={svgPaths.p1423b00} fill="white" />
  </svg>
);

const VehicleIcon2 = () => (
  <svg className="w-6 md:w-10 h-auto" fill="none" viewBox="0 0 40 32">
    <path d={svgPaths.p25b8500} fill="white" />
  </svg>
);

const VehicleIcon3 = () => (
  <svg className="w-8 md:w-[50px] h-auto" fill="none" viewBox="0 0 50 40">
    <path d={svgPaths.p5493a00} fill="white" />
  </svg>
);

const CargoIcon1 = () => (
  <svg className="w-6 md:w-[35px] h-auto" fill="none" viewBox="0 0 35 35">
...
const CargoIcon4 = () => (
  <svg className="w-8 md:w-[43px] h-auto" fill="none" viewBox="0 0 44.5154 29.4228">
...
const PassengerIcon = () => (
  <svg className="w-16 md:w-[90px] h-auto" fill="none" viewBox="0 0 90 90">
...
function Hero() {
  return (
    <section className="relative mt-20 md:mt-[135px] h-[500px] md:h-[842px] overflow-hidden">
      <img alt="" className="absolute inset-0 w-full h-full object-cover" src={imgRectangle4.src} />
      <div className="absolute inset-0 bg-black/40" />

      <div className="relative max-w-[1440px] mx-auto px-4 md:px-8 h-full flex flex-col items-center justify-center text-white text-center">
        <h1 className="text-4xl md:text-[70px] font-bold mb-2 md:mb-4" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.8)' }}>
          Welcome to
        </h1>
        <h2 className="text-5xl md:text-[80px] font-bold mb-10 md:mb-16" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.8)' }}>
          Dean's Shipping Ltd.
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:block h-[2px] w-12 md:w-20 bg-white/50 rounded-full" />
              <span className="text-base md:text-lg font-medium whitespace-nowrap uppercase tracking-widest">Vehicle</span>
              <div className="hidden sm:block h-[2px] w-12 md:w-20 bg-white/50 rounded-full" />
            </div>
          </div>

          {/* Divider */}
          <div className="hidden md:block h-20 md:h-[118px] w-[2px] bg-white/30" />
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:block h-[2px] w-12 md:w-[120px] bg-white/50 rounded-full" />
              <span className="text-base md:text-lg font-medium uppercase tracking-widest">Cargo</span>
              <div className="hidden sm:block h-[2px] w-12 md:w-[120px] bg-white/50 rounded-full" />
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-base md:text-lg font-medium uppercase tracking-widest">Passengers</span>
          </div>
        </div>
      </div>
    </section>
...
const sectionTitleStyle = "text-3xl md:text-[40px] font-semibold text-[#296341] mb-6 md:mb-12 text-center md:text-left";
const sectionTextStyle = "text-lg md:text-[28px] font-light text-black leading-relaxed text-center md:text-left";
    ...
    <section className="py-12 md:py-24 px-4 md:px-8">
      <div className="max-w-[1440px] mx-auto">
        <div className="max-w-[1077px] mx-auto">
          <h2 className={sectionTitleStyle}>About Us</h2>
...
function OperationsSection() {
  return (
    <section className="py-12 md:py-24 px-4 md:px-8 bg-[#effaf6]">
      <div className="max-w-[1440px] mx-auto">
        <div className="max-w-[1103px] mx-auto">
          <h2 className={sectionTitleStyle}>OUR OPERATIONS</h2>
          <div className="space-y-6 md:space-y-8">
            <p className="text-lg md:text-[28px] text-black leading-relaxed text-center md:text-left font-medium">
            ...
            <p className="text-lg md:text-[28px] text-black leading-relaxed text-center md:text-left">
...
function TeamSection() {
  return (
    <section className="py-12 md:py-24 px-4 md:px-8 bg-[#effaf6] border-t border-emerald-100">
      <div className="max-w-[1440px] mx-auto">
          ...
          {[
            {
              name: "Ernest Dean Jr.",
              role: "Owner",
              img: imgEllipse10.src,
              text: "Ernest Dean Jr. was born on February 27, 1962 as the last child to Captain Ernest and Mrs. Eula Dean. Birthed into a family of seafarers, it was only natural that he too would be drawn to the call of the sea. His introduction to life on the boat came at the age of 8…"
            },
            {
              name: "Ernest Dean",
              role: "Founder",
              img: imgEllipse11.src,
              text: "The late, Captain Ernest Alexander Dean was born on May 23, 1915, in the quaint settlement of Sandy Point, Abaco, Bahamas. As the eldest son of a fishing smack captain, Ernest's introduction to the sea came very early on in life. At the tender age of 9, he went to liv..."
            }
          ].map((member, idx) => (
            <div key={idx} className="flex flex-col md:flex-row gap-8 md:gap-16 items-center md:items-start text-center md:text-left">
              <div className="flex-shrink-0 w-[200px] h-[200px] md:w-[300px] md:h-[300px] rounded-full overflow-hidden border-4 border-white shadow-xl">
                <img alt={member.name} className="w-full h-full object-cover" src={member.img} />
              </div>
              <div className="flex-1">
                <h3 className="text-2xl md:text-[40px] font-semibold text-[#296341] mb-4 md:mb-8">{member.name} | {member.role}</h3>
                <p className="text-base md:text-[28px] text-black leading-relaxed mb-4 md:mb-6">
                  {member.text}
                </p>
                <button className="text-base md:text-[28px] font-bold text-[#296341] hover:underline decoration-2 underline-offset-8">
                  Learn More....
                </button>
              </div>
            </div>
...
function TrackingSection() {
  return (
    <section className="py-12 md:py-24 px-4 md:px-8">
      <div className="max-w-[1440px] mx-auto">
        <div className="max-w-[1088px] mx-auto space-y-8 md:space-y-12">
          <p className="text-lg md:text-[28px] font-medium text-[#296341] leading-relaxed text-center md:text-left italic">
          ...
          <p className="text-base md:text-[28px] font-light text-[#296341] leading-relaxed text-center md:text-left">
      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="space-y-6 md:space-y-8 text-center md:text-left">
            <h2 className="text-3xl md:text-[40px] font-semibold text-[#296341] mb-8 md:mb-12">Our Services Include</h2>

            {[
              { title: "Private Shipments:", desc: "Safe and secure transportation of your private goods between islands and throughout the Caribbean." },
              { title: "Large Aggregate Shipping:", desc: "We specialize in handling large cargo like construction materials, machinery, and more, ensuring safe delivery to your destination." },
              { title: "Vehicle Shipments:", desc: "Transport your cars, trucks, and other vehicles with ease and reliability." }
            ].map((service, idx) => (
              <div key={idx} className="bg-white/50 p-6 md:p-0 md:bg-transparent rounded-xl">
                <h3 className="text-xl md:text-[28px] font-bold text-[#296341] mb-2">{service.title}</h3>
                <p className="text-base md:text-[28px] text-[#296341] leading-relaxed opacity-80">
                  {service.desc}
                </p>
              </div>
            ))}
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="bg-[#5f8a71] absolute inset-[-12px] md:inset-[-24px] rounded-lg opacity-20" />
            <img alt="Shipping services" className="relative w-full h-[300px] md:h-[573px] object-cover rounded-lg shadow-2xl" src={imgRectangle56.src} />
          </div>
        </div>
      </div>
    </section>
